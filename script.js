document.addEventListener('DOMContentLoaded', () => {
    ...
    const app = {
        ...
        async callGeminiAPI(prompt, outputElement) {
            ...
            try {
                // Using gemini-1.5-flash for speed and lower cost, or gemini-1.5-pro for deeper reasoning
const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/v1beta/models/gemini-1.5-flash:generateContent?key=${this.apiKey}`, {
                    method: 'POST',
